  ...
  return (
    <article id="About" className="bg-main-100 flex flex-col justify-center items-center w-full h-fit min-h-screen p-8 text-left">
      <div className="max-w-xs mt-5">
        <h1 className="inline font-heading font-bold text-xl ">About </h1>
        <h1 className="inline font-heading  font-bold text-xl text-sub-2">Ryan</h1>
        ...
        <h1 className="font-heading font-bold text-xl text-sub-2">Skills stack </h1>
        <div className="flex-col py-6">
