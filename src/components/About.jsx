  ...
  return (
    <article name="About" className="bg-main-100 flex flex-col justify-center items-center w-screen h-fit min-h-screen p-8 text-left">
      <div className="max-w-xs items-center justify-center">
        <h1 className="inline tracking-wider font-heading font-bold text-2xl ">About </h1>
        <h1 className="inline tracking-wider font-heading font-bold text-2xl text-sub-2">Ryan</h1>
        ...
        <h1 className="tracking-wider font-heading font-bold text-2xl text-sub-2">Skills stack </h1>
        <div className="flex-col py-6">
          <h2 className="tracking-tight font-bold mb-2">Languages</h2>
          ...
          <h2 className="tracking-tight font-bold mb-2">Libraries</h2>
          <div className="flex flex-wrap mb-5">
            {libraries.map(image => {
          ...
          <h2 className="tracking-tight font-bold mb-2">Databases</h2>
          <div className="flex flex-wrap mb-5">
            {databases.map(image => {
          ...
          <h2 className="tracking-tight font-bold mb-2">Design</h2>
          <div className="flex flex-wrap mb-5">
            {design.map(image => {
          ...
          <h2 className="tracking-tight font-bold mb-2">Management</h2>
          <div className="flex flex-wrap mb-5">
