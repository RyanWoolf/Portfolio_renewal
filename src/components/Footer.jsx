...
const Footer = () => {
  const selectLastHalfYear = contributions => {
    ...
    const specificList = contributions.slice(182)
  ...
  return (
  <footer className="bg-main-200 flex flex-col justify-center items-center h-fit">
    <div className="px-4 py-4 flex flex-col justify-center items-center">
      <GitHubCalendar username="ryanwoolf" hideColorLegend fontSize={10} blockSize={9} hideTotalCount blockMargin={3}
    ...
    <div className="flex justify-center items-center mt-5 space-x-2.5">
        <a href="https://m.facebook.com/100001865445521/" target="_blank" className="text-gray-400 hover:text-gray-300 ">
        ...
        <a href="https://www.instagram.com/lionwolfhaus/" target="_blank" className="text-gray-400 hover:text-gray-300 ">
        ...
        <a href="https://www.linkedin.com/in/ryan-lee-56541b24a/" target="_blank" className="text-gray-400 hover:text-gray-300">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="currentColor" aria-hidden="true" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
          <span className="sr-only">LinkedIn page</span>
        </a>
        <a href="https://github.com/RyanWoolf?tab=repositories" target="_blank" className="text-gray-400 hover:text-gray-300">
